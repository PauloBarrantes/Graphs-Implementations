...
using namespace std;
        ...
        void Test::testDijkstra(Grafo* grafo){
            double segundos;
            TIME_THIS(algoritmo->dijkstra(grafo), segundos);
            cout << segundos << endl;
        }
        ...
        void Test::testCompleto(){
          ...
          //grafoCompleto
          grafoN1G1 = gengrafo->grafoCompleto(N1);
          grafoN2G1 = gengrafo->grafoCompleto(N2);
          grafoN3G1 = gengrafo->grafoCompleto(N3);
      ...
      // ----- Algorithm 6 --- grafoCompleto //
          ...
          grafoN1G1 = gengrafo->grafoCompleto(NV1);
          grafoN2G1 = gengrafo->grafoCompleto(NV2);
          grafoN3G1 = gengrafo->grafoCompleto(NV3);
      ...
      // ----- Algorithm 7 --- grafoCompleto //
        ...
        void Test::testCasiCompleto(){
          ...
          grafoN1G2 = gengrafo->grafoCasiCompleto(N1);
          grafoN2G2 = gengrafo->grafoCasiCompleto(N2);
          grafoN3G2 = gengrafo->grafoCasiCompleto(N3);
        ...
        void Test::testMuyIncompleto(){
          ...
          grafoN1G4 = gengrafo->grafoMuyIncompleto(N1);
          grafoN2G4 = gengrafo->grafoMuyIncompleto(N2);
          grafoN3G4 = gengrafo->grafoMuyIncompleto(N3);

          //Test de Algoritmos
          // ----- Algorithm 1 --- grafoMuyIncompleto //
          cout << "Prueba de los grafos MuyIncompletos con el algoritmo Dijkstra " <<endl;
          cout << "N1" << endl;
          testDijkstra(grafoN1G4); //Tiempo de ejecución de Dijkstra con n1
          cout << "N2" <<endl;
          testDijkstra(grafoN2G4);//Tiempo de ejecución de Dijkstra con n2
          cout << "N3"<<endl;
          testDijkstra(grafoN3G4);//Tiempo de ejecución de Dijkstra con n3

          // ----- Algorithm 2 --- grafoMuyIncompleto //
          cout << "Prueba de los grafos MuyIncompletos con el algoritmo Floyd " <<endl;
          cout << "N1" << endl;
          testFloyd(grafoN1G4); //Tiempo de ejecución de Floyd con n1
          cout << "N2" <<endl;
          testFloyd(grafoN2G4);//Tiempo de ejecución de Floyd con n2
          cout << "N3"<<endl;
          testFloyd(grafoN3G4);//Tiempo de ejecución de Floyd con n3

          // ----- Algorithm 3 --- grafoMuyIncompleto //
          cout << "Prueba de los grafos MuyIncompletos con el algoritmo Prim " <<endl;
          cout << "N1" << endl;
          testPrim(grafoN1G4); //Tiempo de ejecución de Prim con n1
          cout << "N2" <<endl;
          testPrim(grafoN2G4);//Tiempo de ejecución de Prim con n2
          cout << "N3"<<endl;
          testPrim(grafoN3G4);//Tiempo de ejecución de Prim con n3

          // ----- Algorithm 4 --- grafoMuyIncompleto //
          cout << "Prueba de los grafos MuyIncompletos con el algoritmo Kruskal " <<endl;
          cout << "N1" << endl;
          testKruskal(grafoN1G4); //Tiempo de ejecución de Kruskal con n1
          cout << "N2" <<endl;
          testKruskal(grafoN2G4);//Tiempo de ejecución de Kruskal con n2
          cout << "N3"<<endl;
          testKruskal(grafoN3G4);//Tiempo de ejecución de Kruskal con n3
